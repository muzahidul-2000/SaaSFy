...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full bg-[#ebf6f5] mt-20">
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        ...
        <div className="flex-1 flex items-start md:justify-end gap-20">
            <div>
                <h2 className="font-semibold mb-5 text-[#5cbdb9]">Company</h2>
            ...
            <div>
                <h2 className="font-semibold text-[#5cbdb9] mb-5">Subscribe to our newsletter</h2>
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        ...
                        <button className="w-24 h-9 bg-[#f7cdd1] text-[#2d2d2d] rounded cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © SaaSfy. All Right Reserved.
    </p>
</footer>
  )
}
