...
const WriteArticle = () => {
  ...
  const [content, setContent] = useState('');   // ✅ Added missing state
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]">
        ...
        {!content ? (
          ...
          <>
            ...
            {/* ✅ Download button below article */}
            <button
              onClick={downloadPDF}
              className="mt-4 flex items-center justify-center gap-2 bg-[#226BFF] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#1a55cc]"
            >
